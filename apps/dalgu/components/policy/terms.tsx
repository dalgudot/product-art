        ...
        {type === 'Subscription' && (
          <section className={style.section}>
            ...
            <p>
              ...
              off at least 24-hours before the end of the subscription period,
              and subscription renewal fees will be charged to your Apple
              account.
            </p>
            <p>
              - You can cancel automatic subscription renewal at any time in the
              Settings of your Apple Account. No refunds will be made for any
              unused period.
            </p>
          </section>
        )}
